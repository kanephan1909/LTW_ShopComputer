        ...
        s = (t, r) => {
            t.forEach((o, i) => {
                ...
                l.setAttribute("src", g + o.image + ".gif"),
                    ...
                    (u.innerText = o.qty),
                    (p.innerText = o.total),
                    o.stock > 10 ? (m.innerHTML = '<div class="badge badge-light-success">In Stock</div>') : (m.innerHTML = '<div class="badge badge-light-warning">Low Stock</div>'),
                    1 === t.length || t.length;
                    ...
                    (() => {
                        ...
                        var t = Date.now(),
                            ...
                            i = {
                                ...
                                showCurrentTime: !1,
                                xss: { disabled: !1, filterOptions: { whiteList: { div: ["class", "style"], img: ["src", "alt"], a: ["href", "class"] } } },
                                template: function (e) {
                                    const t = e.users;
                                    let r = "";
                                    return (
                ...
                e &&
                    am5.ready(function () {
                        ...
                        var a = t.container.children.push(am5map.MapChart.new(t, { panX: "translateX", panY: "translateY", projection: am5map.geoMercator(), paddingLeft: 0, paddingrIGHT: 0, paddingBottom: 0 })),
                            r = a.series.push(am5map.MapPolygonSeries.new(t, { geoJSON: am5geodata_worldLow, exclude: ["AQ"] }));
                        r.mapPolygons.template.setAll({ tooltipText: "{name}", toggleKey: "active", interactive: !0, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")) }),
                            r.mapPolygons.template.states.create("hover", { fill: am5.color(KTUtil.getCssVariableValue("--bs-success")) }),
                            r.mapPolygons.template.states.create("active", { fill: am5.color(KTUtil.getCssVariableValue("--bs-success")) });
                        var o = a.series.push(am5map.MapPolygonSeries.new(t, { geoJSON: am5geodata_worldLow, include: ["US", "BR", "RU"] }));
                        o.mapPolygons.template.setAll({ tooltipText: "{name}", toggleKey: "active", interactive: !0 }),
                            ...
                            o.mapPolygons.template.states.create("hover", { fill: t.interfaceColors.get("primaryButtonHover") }),
                            o.mapPolygons.template.states.create("active", { fill: t.interfaceColors.get("primaryButtonHover") }),
        ...
        !(function () {
            ...
            if (e) {
                var t = e.getAttribute("data-kt-chart-color"),
                    ...
                    s = new ApexCharts(e, {
                        series: [{ name: "Net Profit", data: [30, 75, 55, 45, 30, 60, 75, 50], margin: { left: 5, right: 5 } }],
                        ...
                        xaxis: { axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { show: !1, style: { colors: r, fontSize: "12px" } }, crosshairs: { show: !1 } },
    ...
    init: function () {
        !(function () {
            ...
            if (e) {
                ...
                (a.width = a.height = t.size), e.appendChild(r), e.appendChild(a), o.translate(t.size / 2, t.size / 2), o.rotate((t.rotate / 180 - 0.5) * Math.PI);
                ...
                s("#E4E6EF", t.lineWidth, 1), s(KTUtil.getCssVariableValue("--bs-primary"), t.lineWidth, 100 / 150), s(KTUtil.getCssVariableValue("--bs-success"), t.lineWidth, 0.4);
            }
        })();
    },
};
    ...
    init: function () {
        !(function () {
            ...
            if (e) {
                ...
                s("#E4E6EF", t.lineWidth, 1), s(KTUtil.getCssVariableValue("--bs-danger"), t.lineWidth, 100 / 150), s(KTUtil.getCssVariableValue("--bs-primary"), t.lineWidth, 0.4);
            }
        })();
    },
};
            ...
            if (e) {
                var t = parseInt(KTUtil.css(e, "height")),
                    ...
                    s = new ApexCharts(e, {
                        ...
                        colors: [o, i],
                        grid: { padding: { left: 10, right: 10 }, borderColor: r, strokeDashArray: 4, yaxis: { lines: { show: !0 } } },
                    });
                setTimeout(function () {
                    s.render();
                }, 300);
        ...
        !(function () {
            ...
            if (e) {
                var t = parseInt(KTUtil.css(e, "height")),
                    ...
                    o = new ApexCharts(e, {
                        series: [{ name: "Net Profit", data: [35, 25, 45, 15, 60, 50, 57, 35, 70, 40, 45, 25, 45, 30, 70] }],
        ...
        !(function () {
            ...
            if (e) {
                var t = parseInt(KTUtil.css(e, "height")),
                    ...
                    r = KTUtil.getCssVariableValue("--bs-light-info"),
                    o = new ApexCharts(e, {
                        series: [{ name: "Net Profit", data: [35, 25, 35, 15, 40, 60, 25, 40, 70, 30, 55, 45, 45, 30, 50] }],
                        chart: { fontFamily: "inherit", type: "area", height: t, toolbar: { show: !1 } },
                        legend: { show: !1 },
                        dataLabels: { enabled: !1 },
                        fill: { type: "solid", opacity: 0 },
        ...
        !(function () {
            ...
            if (e) {
                var t = e.hasAttribute("data-kt-negative-color") ? e.getAttribute("data-kt-negative-color") : KTUtil.getCssVariableValue("--bs-success"),
                    ...
                    s = new ApexCharts(e, {
                        series: [
                            { name: "Net Profit", data: [20, 30, 20, 40, 60, 75, 65, 18, 10, 5, 15, 40, 60, 18, 35, 55, 20] },
                            { name: "Revenue", data: [-20, -15, -5, -20, -30, -15, -10, -8, -5, -5, -10, -25, -15, -5, -10, -5, -15] },
                        ],
                ...
                e &&
                    am5.ready(function () {
                        ...
                        var r = [
                            ...
                            o = a.xAxes.push(am5xy.CategoryAxis.new(t, { categoryField: "year", startLocation: 0.5, endLocation: 0.5, renderer: am5xy.AxisRendererX.new(t, {}), tooltip: am5.Tooltip.new(t, {}) }));
                        ...
                        function s(e, s, l) {
                            ...
                            n.fills.template.setAll({ fillOpacity: 0.5, visible: !0 }), n.data.setAll(r), n.appear(1e3);
                        }
                        i.get("renderer").grid.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3] }),
                            i.get("renderer").labels.template.setAll({ fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }),
                            s("Cars", "cars", KTUtil.getCssVariableValue("--bs-primary")),
                            s("Motorcycles", "motorcycles", KTUtil.getCssVariableValue("--bs-success")),
                            s("Bicycles", "bicycles", KTUtil.getCssVariableValue("--bs-warning")),
                        ...
                        o.createAxisRange(l),
                            l.get("grid").setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-200")), strokeOpacity: 0.5, strokeDasharray: [3] }),
                            l.get("axisFill").setAll({ fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-200")), fillOpacity: 0.1 }),
                            l.get("label").setAll({ inside: !0, text: "Fines increased", rotation: 90, centerX: am5.p100, centerY: am5.p100, location: 0, paddingBottom: 10, paddingRight: 15 });
            ...
            if ("undefined" != typeof am5) {
                ...
                e &&
                    am5.ready(function () {
                        ...
                        var i = a.xAxes.push(am5xy.ValueAxis.new(t, { renderer: o, min: 0, max: 100, strictMinMax: !0, numberFormat: "#'%'", tooltip: am5.Tooltip.new(t, {}) })),
                            s = am5radar.AxisRendererRadial.new(t, { minGridDistance: 20 });
                        s.labels.template.setAll({ centerX: am5.p100, fontWeight: "500", fontSize: 18, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")), templateField: "columnSettings" }),
                            s.grid.template.setAll({ forceHidden: !0 });
                        var l = a.yAxes.push(am5xy.CategoryAxis.new(t, { categoryField: "category", renderer: s }));
                        l.data.setAll(r);
                        var n = a.series.push(am5radar.RadarColumnSeries.new(t, { xAxis: i, yAxis: l, clustered: !1, valueXField: "full", categoryYField: "category", fill: t.interfaceColors.get("alternativeBackground") }));
                        n.columns.template.setAll({ width: am5.p100, fillOpacity: 0.08, strokeOpacity: 0, cornerRadius: 20 }), n.data.setAll(r);
                        var d = a.series.push(am5radar.RadarColumnSeries.new(t, { xAxis: i, yAxis: l, clustered: !1, valueXField: "value", categoryYField: "category" }));
            ...
            if ("undefined" != typeof am5) {
                ...
                e &&
                    am5.ready(function () {
                        ...
                        o.get("renderer").labels.template.setAll({ paddingTop: 20, fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }),
                            o.get("renderer").grid.template.setAll({ disabled: !0, strokeOpacity: 0 }),
                            o.data.setAll(r);
                        var i = a.yAxes.push(am5xy.ValueAxis.new(t, { renderer: am5xy.AxisRendererY.new(t, {}) }));
                        i.get("renderer").grid.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3] }),
                        ...
                        s.columns.template.setAll({ tooltipText: "{categoryX}: {valueY}", tooltipY: 0, strokeOpacity: 0, templateField: "columnSettings" }),
                            s.columns.template.setAll({ strokeOpacity: 0, cornerRadiusBR: 0, cornerRadiusTR: 6, cornerRadiusBL: 0, cornerRadiusTL: 6 }),
                            s.data.setAll(r),
                            s.appear(),
                            a.appear(1e3, 100);
                    });
            ...
            if ("undefined" != typeof am5) {
                ...
                e &&
                    am5.ready(function () {
                        ...
                        var o = a.xAxes.push(am5xy.CategoryAxis.new(t, { categoryField: "country", renderer: am5xy.AxisRendererX.new(t, { minGridDistance: 30 }) }));
                        o.get("renderer").labels.template.setAll({ paddingTop: 10, fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }),
                            ...
                            o.data.setAll(r);
                        var i = a.yAxes.push(am5xy.ValueAxis.new(t, { renderer: am5xy.AxisRendererY.new(t, {}) }));
                        i.get("renderer").labels.template.setAll({ paddingLeft: 10, fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }),
                            i.get("renderer").grid.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3] });
                        var s = am5xy.AxisRendererY.new(t, { opposite: !0 }),
                            l = a.yAxes.push(am5xy.ValueAxis.new(t, { renderer: s, min: 0, max: 100, strictMinMax: !0 }));
                        l.get("renderer").labels.template.setAll({ fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }), s.grid.template.set("forceHidden", !0), l.set("numberFormat", "#'%");
                        var n = a.series.push(am5xy.ColumnSeries.new(t, { xAxis: o, yAxis: i, valueYField: "visits", categoryXField: "country" }));
                        ...
                        var d = a.series.push(am5xy.LineSeries.new(t, { xAxis: o, yAxis: l, valueYField: "pareto", categoryXField: "country", stroke: am5.color(KTUtil.getCssVariableValue("--bs-dark")), maskBullets: !1 }));
                        d.bullets.push(function () {
                            return am5.Bullet.new(t, {
                                locationY: 1,
                                sprite: am5.Circle.new(t, { radius: 5, fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")), stroke: am5.color(KTUtil.getCssVariableValue("--bs-dark")) }),
                            });
                        }),
                            n.data.setAll(r),
                            d.data.setAll(r),
        ...
        !(function () {
            ...
            if (e) {
                var t = parseInt(KTUtil.css(e, "height")),
                    ...
                    i = KTUtil.getCssVariableValue("--bs-primary"),
                    s = new ApexCharts(e, {
                        series: [{ name: "Discounted", data: [34.5, 34.5, 35, 35, 35.5, 35.5, 35, 35, 34.5, 34.5, 34.5, 34.5, 35, 35, 34.5, 35.5, 35.5, 35.5, 35] }],
                        chart: { fontFamily: "inherit", type: "area", height: t, toolbar: { show: !1 } },
                        plotOptions: {},
                        legend: { show: !1 },
                        dataLabels: { enabled: !1 },
            ...
            if (e) {
                var t = parseInt(KTUtil.css(e, "height")),
                    ...
                    s = {
                        ...
                        colors: [o, i],
                        grid: { borderColor: r, strokeDashArray: 4, yaxis: { lines: { show: !0 } } },
                        markers: { colors: [o, i], strokeColor: [KTUtil.getCssVariableValue("--bs-danger"), KTUtil.getCssVariableValue("--bs-warning")], strokeWidth: 3 },
                    },
